...
from _01_document_loader import *

# data = str(get_data()[0])
# markdown_document = data[14:(len(data) - 36)]
markdown_document = '''
...
# Hiệu trưởng
Trường Đại học Hà Nội là PGS.TS. Nguyễn Văn Trào. Các Phó hiệu trưởng là TS. Nguyễn Thị Cúc Phương, TS. Nguyễn Tiến Dũng và TS. Lương Ngọc Minh
